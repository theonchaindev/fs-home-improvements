...
export const projects: Project[] = [
  ...
  },
  {
    ...
    fullDescription: "The customer wanted to replace all the windows in their detached property with modern, energy-efficient uPVC units. We supplied and installed white uPVC casement windows throughout the house, each fitted with A-rated double glazing for outstanding thermal performance. The clean white finish has refreshed the whole exterior, and the homeowner has already noticed a significant reduction in draughts and heat loss.",
    ...
    scope: "Full property window replacement — multiple casement units",
    duration: "2 days",
    challenge: "Coordinating a full house replacement in a single visit to minimise disruption to the homeowner.",
    result: "A completely refreshed exterior with noticeably improved warmth and reduced energy costs.",
